...
export interface FloNFTInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "totalSpply", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "transferOwnership",
    data: BytesLike
  ): Result;
...
export interface FloNFT extends BaseContract {
  ...
  totalSpply: TypedContractMethod<[], [bigint], "view">;
